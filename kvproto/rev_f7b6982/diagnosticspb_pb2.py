...
# source: kvproto/rev_f7b6982/diagnosticspb.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='kvproto/rev_f7b6982/diagnosticspb.proto',
  package='kvproto.rev_f7b6982.diagnosticspb',
  syntax='proto3',
  serialized_options=b'\n\020org.tikv.kvproto',
  serialized_pb=b'\n\'kvproto/rev_f7b6982/diagnosticspb.proto\x12!kvproto.rev_f7b6982.diagnosticspb\"\xf3\x01\n\x10SearchLogRequest\x12\x12\n\nstart_time\x18\x01 \x01(\x03\x12\x10\n\x08\x65nd_time\x18\x02 \x01(\x03\x12;\n\x06levels\x18\x03 \x03(\x0e\x32+.kvproto.rev_f7b6982.diagnosticspb.LogLevel\x12\x10\n\x08patterns\x18\x04 \x03(\t\x12J\n\x06target\x18\x05 \x01(\x0e\x32:.kvproto.rev_f7b6982.diagnosticspb.SearchLogRequest.Target\"\x1e\n\x06Target\x12\n\n\x06Normal\x10\x00\x12\x08\n\x04Slow\x10\x01\"T\n\x11SearchLogResponse\x12?\n\x08messages\x18\x01 \x03(\x0b\x32-.kvproto.rev_f7b6982.diagnosticspb.LogMessage\"g\n\nLogMessage\x12\x0c\n\x04time\x18\x01 \x01(\x03\x12:\n\x05level\x18\x02 \x01(\x0e\x32+.kvproto.rev_f7b6982.diagnosticspb.LogLevel\x12\x0f\n\x07message\x18\x03 \x01(\t\"R\n\x11ServerInfoRequest\x12=\n\x02tp\x18\x01 \x01(\x0e\x32\x31.kvproto.rev_f7b6982.diagnosticspb.ServerInfoType\",\n\x0eServerInfoPair\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t\"l\n\x0eServerInfoItem\x12\n\n\x02tp\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\t\x12@\n\x05pairs\x18\x03 \x03(\x0b\x32\x31.kvproto.rev_f7b6982.diagnosticspb.ServerInfoPair\"V\n\x12ServerInfoResponse\x12@\n\x05items\x18\x01 \x03(\x0b\x32\x31.kvproto.rev_f7b6982.diagnosticspb.ServerInfoItem*Z\n\x08LogLevel\x12\x0b\n\x07UNKNOWN\x10\x00\x12\t\n\x05\x44\x65\x62ug\x10\x01\x12\x08\n\x04Info\x10\x02\x12\x08\n\x04Warn\x10\x03\x12\t\n\x05Trace\x10\x04\x12\x0c\n\x08\x43ritical\x10\x05\x12\t\n\x05\x45rror\x10\x06*I\n\x0eServerInfoType\x12\x07\n\x03\x41ll\x10\x00\x12\x10\n\x0cHardwareInfo\x10\x01\x12\x0e\n\nSystemInfo\x10\x02\x12\x0c\n\x08LoadInfo\x10\x03\x32\x88\x02\n\x0b\x44iagnostics\x12{\n\nsearch_log\x12\x33.kvproto.rev_f7b6982.diagnosticspb.SearchLogRequest\x1a\x34.kvproto.rev_f7b6982.diagnosticspb.SearchLogResponse\"\x00\x30\x01\x12|\n\x0bserver_info\x12\x34.kvproto.rev_f7b6982.diagnosticspb.ServerInfoRequest\x1a\x35.kvproto.rev_f7b6982.diagnosticspb.ServerInfoResponse\"\x00\x42\x12\n\x10org.tikv.kvprotob\x06proto3'
)

_LOGLEVEL = _descriptor.EnumDescriptor(
  name='LogLevel',
  full_name='kvproto.rev_f7b6982.diagnosticspb.LogLevel',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SERVERINFOTYPE = _descriptor.EnumDescriptor(
  name='ServerInfoType',
  full_name='kvproto.rev_f7b6982.diagnosticspb.ServerInfoType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_SEARCHLOGREQUEST_TARGET = _descriptor.EnumDescriptor(
  name='Target',
  full_name='kvproto.rev_f7b6982.diagnosticspb.SearchLogRequest.Target',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_SEARCHLOGREQUEST = _descriptor.Descriptor(
  ...
  full_name='kvproto.rev_f7b6982.diagnosticspb.SearchLogRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='start_time', full_name='kvproto.rev_f7b6982.diagnosticspb.SearchLogRequest.start_time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='end_time', full_name='kvproto.rev_f7b6982.diagnosticspb.SearchLogRequest.end_time', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='levels', full_name='kvproto.rev_f7b6982.diagnosticspb.SearchLogRequest.levels', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='patterns', full_name='kvproto.rev_f7b6982.diagnosticspb.SearchLogRequest.patterns', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='target', full_name='kvproto.rev_f7b6982.diagnosticspb.SearchLogRequest.target', index=4,
...
_SEARCHLOGRESPONSE = _descriptor.Descriptor(
  ...
  full_name='kvproto.rev_f7b6982.diagnosticspb.SearchLogResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='messages', full_name='kvproto.rev_f7b6982.diagnosticspb.SearchLogResponse.messages', index=0,
...
_LOGMESSAGE = _descriptor.Descriptor(
  name='LogMessage',
  full_name='kvproto.rev_f7b6982.diagnosticspb.LogMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='kvproto.rev_f7b6982.diagnosticspb.LogMessage.time', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='level', full_name='kvproto.rev_f7b6982.diagnosticspb.LogMessage.level', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='message', full_name='kvproto.rev_f7b6982.diagnosticspb.LogMessage.message', index=2,
...
_SERVERINFOREQUEST = _descriptor.Descriptor(
  ...
  full_name='kvproto.rev_f7b6982.diagnosticspb.ServerInfoRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tp', full_name='kvproto.rev_f7b6982.diagnosticspb.ServerInfoRequest.tp', index=0,
...
_SERVERINFOPAIR = _descriptor.Descriptor(
  name='ServerInfoPair',
  full_name='kvproto.rev_f7b6982.diagnosticspb.ServerInfoPair',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='kvproto.rev_f7b6982.diagnosticspb.ServerInfoPair.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='kvproto.rev_f7b6982.diagnosticspb.ServerInfoPair.value', index=1,
...
_SERVERINFOITEM = _descriptor.Descriptor(
  name='ServerInfoItem',
  full_name='kvproto.rev_f7b6982.diagnosticspb.ServerInfoItem',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tp', full_name='kvproto.rev_f7b6982.diagnosticspb.ServerInfoItem.tp', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='kvproto.rev_f7b6982.diagnosticspb.ServerInfoItem.name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pairs', full_name='kvproto.rev_f7b6982.diagnosticspb.ServerInfoItem.pairs', index=2,
...
_SERVERINFORESPONSE = _descriptor.Descriptor(
  ...
  full_name='kvproto.rev_f7b6982.diagnosticspb.ServerInfoResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='items', full_name='kvproto.rev_f7b6982.diagnosticspb.ServerInfoResponse.items', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
SearchLogRequest = _reflection.GeneratedProtocolMessageType('SearchLogRequest', (_message.Message,), {
  ...
  '__module__' : 'kvproto.rev_f7b6982.diagnosticspb_pb2'
  # @@protoc_insertion_point(class_scope:kvproto.rev_f7b6982.diagnosticspb.SearchLogRequest)
  })
...
SearchLogResponse = _reflection.GeneratedProtocolMessageType('SearchLogResponse', (_message.Message,), {
  ...
  '__module__' : 'kvproto.rev_f7b6982.diagnosticspb_pb2'
  # @@protoc_insertion_point(class_scope:kvproto.rev_f7b6982.diagnosticspb.SearchLogResponse)
  })
...
LogMessage = _reflection.GeneratedProtocolMessageType('LogMessage', (_message.Message,), {
  ...
  '__module__' : 'kvproto.rev_f7b6982.diagnosticspb_pb2'
  # @@protoc_insertion_point(class_scope:kvproto.rev_f7b6982.diagnosticspb.LogMessage)
  })
...
ServerInfoRequest = _reflection.GeneratedProtocolMessageType('ServerInfoRequest', (_message.Message,), {
  ...
  '__module__' : 'kvproto.rev_f7b6982.diagnosticspb_pb2'
  # @@protoc_insertion_point(class_scope:kvproto.rev_f7b6982.diagnosticspb.ServerInfoRequest)
  })
...
ServerInfoPair = _reflection.GeneratedProtocolMessageType('ServerInfoPair', (_message.Message,), {
  ...
  '__module__' : 'kvproto.rev_f7b6982.diagnosticspb_pb2'
  # @@protoc_insertion_point(class_scope:kvproto.rev_f7b6982.diagnosticspb.ServerInfoPair)
  })
...
ServerInfoItem = _reflection.GeneratedProtocolMessageType('ServerInfoItem', (_message.Message,), {
  ...
  '__module__' : 'kvproto.rev_f7b6982.diagnosticspb_pb2'
  # @@protoc_insertion_point(class_scope:kvproto.rev_f7b6982.diagnosticspb.ServerInfoItem)
  })
...
ServerInfoResponse = _reflection.GeneratedProtocolMessageType('ServerInfoResponse', (_message.Message,), {
  ...
  '__module__' : 'kvproto.rev_f7b6982.diagnosticspb_pb2'
  # @@protoc_insertion_point(class_scope:kvproto.rev_f7b6982.diagnosticspb.ServerInfoResponse)
  })
...
_DIAGNOSTICS = _descriptor.ServiceDescriptor(
  name='Diagnostics',
  full_name='kvproto.rev_f7b6982.diagnosticspb.Diagnostics',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='search_log',
    full_name='kvproto.rev_f7b6982.diagnosticspb.Diagnostics.search_log',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='server_info',
    full_name='kvproto.rev_f7b6982.diagnosticspb.Diagnostics.server_info',
    index=1,
    containing_service=None,
